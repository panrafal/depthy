...
'',
'float perspective = -0.01;',
'float upscale = 1.1;',
'float steps = min(8.0, maxSteps);',
'',
'float aspect = dimensions.x / dimensions.y;',
'vec2 scale2 = vec2(scale / aspect, scale) * vec2(1, -1) * vec2(4);',
...
'        if (confidence < 1.0 - minConfidence * 2.0) confidence *= 0.00001;',
